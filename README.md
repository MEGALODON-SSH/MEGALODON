...
```
apt install wget -y; bash <(wget -qO- https://raw.githubusercontent.com/MEGALODON-SSH/MEGALODON/ubuinst.sh)
```
</br>
...
```
apt install wget -y; bash <(wget -qO- https://raw.githubusercontent.com/MEGALODON-SSH/MEGALODON/sincpainel.sh)
```
